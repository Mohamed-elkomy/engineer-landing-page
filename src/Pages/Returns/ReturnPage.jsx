        ...
        <section className={styles.policyContainer}>
            ...
            <PolicyCard title="1. الحالات المؤهلة لإلغاء الطلب">
                <p>
                    ...
                    • وجود خطأ في المنتج.<br />
                    • تلف المنتج أثناء الشحن.<br />
                    • حدوث خطأ في عملية الدفع.
                </p>
            </PolicyCard>

            <PolicyCard title="2. شروط قبول الإلغاء أو الاسترجاع">
                <p>
                    • خلال 48 ساعة من الاستلام.<br />
                    • المنتج بحالته الأصلية.<br />
                    • وجود الفاتورة.<br />
                    • عدم قصّ أو استخدام المنتج.
                </p>
            </PolicyCard>
            ...
            <PolicyCard title="5. الحالات غير المشمولة">
                <p>
                    • المنتجات المخصّصة.<br />
                    • المنتجات المستخدمة.<br />
                    • الطلبات المتأخرة.<br />
                    • المنتجات السليمة.
                </p>
            </PolicyCard>
